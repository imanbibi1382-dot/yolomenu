          ...
          return (
            ...
            >
              <h2 className="font-bold text-xl px-6 mb-4 sticky top-[104px] bg-background/95 backdrop-blur-md py-2 z-10 flex items-center gap-2">
                <span className="w-1 h-6 bg-yolo-gold rounded-full inline-block"></span>
                {category.name}
              </h2>
        ...
        <div className="px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-10 rounded-full bg-muted/50 border-transparent focus:border-primary focus:bg-background focus:ring-1 focus:ring-primary transition-all text-sm outline-none placeholder:text-muted-foreground/70"
            />
            {searchQuery && (
              <button 
